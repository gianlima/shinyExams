...
Question
========
Qual a distância entre os dois pontos
$p = (`r p[1]`, `r p[2]`)$ e $q = (`r q[1]`, `r q[2]`)$
em um sistema de coordenadas cartesianas?

Solution
========
A distância $d$ de $p$ até $q$ é dada por
$d^2 = (p_1 - q_1)^2 + (p_2 - q_2)^2$ (Fórmula pitagórica).

Portanto, $d = \sqrt{(p_1 - q_1)^2 + (p_2 - q_2)^2} =
...
exname: Distância euclidiana entre 2 pontos sem opção de resposta;;
extol: 0.01
